(() => {
    ...
    async function ensureBattleModuleLoaded() {
        if (window.EchoesOfTheCityBattle?.createDebugBattleController) {
            ...
            fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"A",location:"index.js:ensureBattleModuleLoaded",msg:"[DEBUG] Battle module already present on window",data:{hasFactory:true},ts:Date.now()})}).catch(()=>{});
            // #endregion
            return;
        }
        ...
        if (!state.battleModulePromise) {
            state.battleModulePromise = (async () => {
                ...
                fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"A",location:"index.js:ensureBattleModuleLoaded",msg:"[DEBUG] Fetching extracted battle module",data:{scriptUrl},ts:Date.now()})}).catch(()=>{});
                // #endregion
                const response = await fetch(scriptUrl);
                if (!response.ok) {
                    // #region debug-point A:battle-module-fetch-failed
                    fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"A",location:"index.js:ensureBattleModuleLoaded",msg:"[DEBUG] Battle module fetch failed",data:{status:response.status,scriptUrl},ts:Date.now()})}).catch(()=>{});
                    // #endregion
                ...
                fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"B",location:"index.js:ensureBattleModuleLoaded",msg:"[DEBUG] Evaluating extracted battle module",data:{sourceLength:scriptSource.length},ts:Date.now()})}).catch(()=>{});
                // #endregion
                window.eval(`${scriptSource}\n//# sourceURL=${scriptUrl}`);

                // #region debug-point B:battle-module-eval-finished
                fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"B",location:"index.js:ensureBattleModuleLoaded",msg:"[DEBUG] Extracted battle module evaluated",data:{hasFactory:Boolean(window.EchoesOfTheCityBattle?.createDebugBattleController)},ts:Date.now()})}).catch(()=>{});
                // #endregion
                if (!window.EchoesOfTheCityBattle?.createDebugBattleController) {
                ...
                fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"B",location:"index.js:ensureBattleModuleLoaded",msg:"[DEBUG] Battle module load rejected",data:{name:error?.name||null,message:error?.message||String(error)},ts:Date.now()})}).catch(()=>{});
                // #endregion
    ...
    async function initializeCombatController() {
        ...
        fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"C",location:"index.js:initializeCombatController",msg:"[DEBUG] Creating debug battle controller",data:{hasMountElement:Boolean(elements.combatContent)},ts:Date.now()})}).catch(()=>{});
        // #endregion
        ...
        fetch("http://127.0.0.1:7777/event",{method:"POST",body:JSON.stringify({sessionId:"combat-module-error",runId:"post-fix",hypothesisId:"C",location:"index.js:initializeCombatController",msg:"[DEBUG] Debug battle controller created",data:{hasController:Boolean(state.combatController)},ts:Date.now()})}).catch(()=>{});
        // #endregion
