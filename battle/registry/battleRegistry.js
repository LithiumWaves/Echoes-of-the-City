(() => {
    ...
    const statusDefinitions = {
        ...
        paralysis: { id: 'paralysis', label: 'Paralysis', countOnly: true },
        paralyze: { id: 'paralysis', label: 'Paralysis', countOnly: true },
    ...
    const effectDefinitions = {
        ...
        queueUnopposedFollowUp: { id: 'queueUnopposedFollowUp', label: 'Queue Unopposed Follow-up' },
        amplitudeConvert: { id: 'amplitudeConvert', label: 'Amplitude Convert (Tremor → Gnaw)' },
        grantSkillOffer: { id: 'grantSkillOffer', label: 'Grant Skill Offer' },
        adjustSlotAggro: { id: 'adjustSlotAggro', label: 'Adjust Slot Aggro' },
        cancelAttack: { id: 'cancelAttack', label: 'Cancel Attack' },
